...
data modify entity @e[type=minecraft:item_display,distance=..1.5,tag=pir.ditem_frame.bb,sort=nearest,limit=1] transformation.right_rotation set value [0.0f,0.0f,-98.0f,100.0f]
data modify entity @e[type=minecraft:item_display,distance=..1.5,tag=pir.ditem_frame.bb,sort=nearest,limit=1] transformation.translation set value [-0.4f,0.1f,-0.1f]
