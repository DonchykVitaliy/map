summon minecraft:vindicator ~ ~1 ~ {Health:220f,attributes:[{id:"minecraft:generic.burning_time",base:1.5},{id:"minecraft:generic.knockback_resistance",base:0.7},{id:"minecraft:generic.movement_speed",base:0.25},{id:"minecraft:generic.max_health",base:220},{id:"minecraft:generic.armor",base:20},{id:"minecraft:generic.attack_knockback",base:2.5},{id:"minecraft:generic.water_movement_efficiency",base:5},{id:"minecraft:generic.follow_range",base:40}],Silent:1b,DeathLootTable:"pirates:mobs/ocean/davy_jones",CustomName:'{"translate":"pir.mob_ocean.davy_jones.bb"}',Tags:["pir.custom_mobs","pir.davy_jones.mob"],HandItems:[{id:"minecraft:iron_sword",components:{custom_model_data:75000},Count:1b}],HandDropChances:[0.000F,0.000F],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:-1,show_particles:0b}],Passengers:[{id:"minecraft:item_display",Tags:["pir.custom_mobs","pir.davy_jones.mob"],shadow_radius:0.5f,shadow_strength:1f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,-360f,0f,360f],translation:[0f,0f,0f],scale:[1f,1f,1f]},brightness: {"sky":20,"block":0},item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_model_data":79380,"minecraft:potion_contents":{custom_color:0}}}}]}
