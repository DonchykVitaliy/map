...
data modify entity @s item.components."minecraft:custom_model_data" set value 79322

execute if score @s pir.death_time matches 1 run playsound entity.skeleton.death hostile @a[distance=..10] ~ ~ ~
