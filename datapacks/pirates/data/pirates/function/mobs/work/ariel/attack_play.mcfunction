...
execute if entity @s[tag=!pir.second_state] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=pir.ariel.mob] item.components.minecraft:custom_model_data set value 79053
execute if entity @s[tag=pir.second_state] run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=pir.ariel.mob] item.components.minecraft:custom_model_data set value 79054
