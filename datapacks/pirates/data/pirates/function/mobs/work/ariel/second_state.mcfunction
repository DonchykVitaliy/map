...
item replace entity @s weapon.mainhand with minecraft:iron_sword[attribute_modifiers=[{id:"attack_damage",type:"attack_damage",amount:10,operation:"add_value"}],minecraft:custom_model_data=75000]
