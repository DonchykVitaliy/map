...
execute if score @s pir.attack_time matches 19.. run data modify entity @e[type=item_display,sort=nearest,limit=1,tag=pir.pirate_2.mob] item.components.minecraft:custom_model_data set value 79500
