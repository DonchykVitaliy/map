#move
execute if entity @s[tag=!pir.reload,tag=!pir.attack_animation_2,tag=!pir.attack_animation_3,tag=!pir.attack_animation4] unless predicate pirates:mobs/move run function pirates:mobs/work/davy_jones/move
...
#attack
execute if score @s pir.attack_2.refresh matches 1.. if score @s pir.attack_4.refresh matches 1.. if entity @s[tag=!pir.attack_animation_2,tag=!pir.attack_animation_3] if entity @a[distance=..2,gamemode=!creative,gamemode=!spectator] as @e[type=item_display,tag=pir.davy_jones.mob,limit=1,sort=nearest,tag=!pir.attack_animation,tag=!pir.attack_animation4,distance=..2] run function pirates:mobs/work/davy_jones/attack_play
...
#attack 4
execute if score @s pir.attack_4.refresh matches ..0 if entity @s[tag=pir.second_state,tag=!pir.attack_animation_2,tag=!pir.attack_animation_3,tag=!pir.attack_animation4] if entity @a[distance=..2,gamemode=!creative,gamemode=!spectator] run function pirates:mobs/work/davy_jones/attack_play_4
