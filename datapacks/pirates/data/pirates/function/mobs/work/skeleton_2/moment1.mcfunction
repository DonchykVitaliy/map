data modify entity @s item.components.minecraft:custom_model_data set value 79324
tag @s add pir.animation_moment
scoreboard players add @s pir.moment_time 1

execute if score @s pir.moment_time matches 79.. run data modify entity @s item.components.minecraft:custom_model_data set value 79320
