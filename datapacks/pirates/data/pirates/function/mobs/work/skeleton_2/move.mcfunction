data modify entity @e[type=item_display,sort=nearest,limit=1,tag=pir.skeleton_2.mob,tag=!pir.attack_animation] item.components.minecraft:custom_model_data set value 79321
